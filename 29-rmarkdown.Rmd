...
Figures that are directly related to your data can be created and added using a code chunk. For example if we want to recreate the scatterplot example from the \@ref(ggplot) section, we would set it up in an R Markdown file as follows:
