...
## R help center
If you need help with R and Rstudio you can talk to a Quant TA in the biology computer Lab (CSF2218) or the help center (CSF2342). You can assess the help center schedule [here](https://github.com/ahurford/quant-guide-all-courses/blob/master/R-help/Katie_Joseph_schedule.pdf).
