...
A line of best fit represents a trendline that approximates the relationship between points of a scatter plot. Most often, we will use a linear equation to estimate this relationship, for example a simple linear regression or `y = mx + b`. Here m represents the slope of the line and b represents the y-intercept. 
